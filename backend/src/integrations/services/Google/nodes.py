from src.integrations.services.Google.gmail import (
    ListLabelsResponse,
    SingleLabelResponse,
...
from src.integrations.services.Google.gsheets import (
    create_google_sheet,
...
from src.integrations.services.Google.drive import (
...
DRAFT_EMAIL_NODE = ApplicationNode(
    ...
    description="Draft emails according to requirement.",
    type=NodesTypeEnum.ACTION,
    node_input_model=SendAndDraftEmailInput,
    node_output_model=SendAndDraftEmailResponse,
)
