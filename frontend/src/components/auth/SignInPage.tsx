    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center px-6">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold">Sign in to wFlow</h1>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl bg-card border border-border hover:border-primary/40 hover:bg-accent/50 text-foreground font-medium transition-all shadow-sm"
        >
