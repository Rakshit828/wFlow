...
export const EdgePropertiesPanel: React.FC = () => {
  ...
  return (
    <aside className="w-full h-full border-l border-border bg-card flex flex-col shadow-2xl z-40 shrink-0">
          ...
          <div>
            ...
            <div className="mt-2 flex gap-2">
              <button
                type="button"
                onClick={() =>
                  updateEdgeProps(activeEdgeId, { decision: true })
                }
              ...
              <button
                type="button"
                onClick={() =>
                  updateEdgeProps(activeEdgeId, { decision: false })
                }
                className={`flex-1 py-2.5 rounded-lg text-sm font-semibold border transition-all ${
                  data.decision === false
        ...
        {data.type === "switch" && (
          <div>
            ...
            <input
              ...
              value={data.case ?? ""}
              onChange={(e) =>
                updateEdgeProps(activeEdgeId, { case: e.target.value })
              }
